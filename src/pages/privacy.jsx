...
function PrivacyPage() {
  return (
    <>
      <h1>Privacy Policy for Sophia Technologies Inc.</h1>

      <p>
        At Feelja, accessible from https://feelja.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by Feelja
        and how we use it.
      </p>
      ...
      <p>
        Sophia Technologies Inc. legal basis for collecting and using the
      ...
      <ul>
        <li>Sophia Technologies Inc. needs to perform a contract with you</li>
        <li>You have given Sophia Technologies Inc. permission to do so</li>
        <li>
          Processing your personal information is in Sophia Technologies Inc.
          legitimate interests
        </li>
        <li>Sophia Technologies Inc. needs to comply with the law</li>
      </ul>

      <p>
        Sophia Technologies Inc. will retain your personal information only for
      ...
      <p>
        Feelja follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, Feelja uses 'cookies'. These cookies are used to
      ...
      <p>
        ...
        advertising partners of Feelja.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Feelja, which are sent directly
      ...
      <p>
        Note that Feelja has no access to or control over these cookies that are
      ...
      <p>
        Feelja's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        Feelja does not knowingly collect any Personal Identifiable Information
      ...
      <p>
        ...
        shared and/or collect in Feelja. This policy is not applicable to any
