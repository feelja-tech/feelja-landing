...
function TermsPage() {
  return (
    <>
      ...
      <p>
        By accessing this Website, accessible from https://feelja.com, you are
      ...
      <p>
        ...
        on Feelja's Website for personal, non-commercial transitory viewing
      ...
      <ul>
        ...
        <li>
          attempt to reverse engineer any software contained on Feelja's
          Website;
        </li>
        <li>
      ...
      <p>
        This will let Feelja to terminate upon violations of any of these
      ...
      <p>
        All the materials on Feelja’s Website are provided "as is". Feelja makes
        no warranties, may it be expressed or implied, therefore negates all
        other warranties. Furthermore, Feelja does not make any representations
      ...
      <p>
        Feelja or its suppliers will not be hold accountable for any damages
        that will arise with the use or inability to use the materials on
        Feelja’s Website, even if Feelja or an authorize representative of this
      ...
      <p>
        The materials appearing on Feelja’s Website may include technical,
        typographical, or photographic errors. Feelja will not promise that any
        of the materials in this Website are accurate, complete, or current.
        Feelja may change the materials contained on its Website at any time
        without notice. Feelja does not make any commitment to update the
        materials.
      </p>
      ...
      <p>
        Feelja has not reviewed all of the sites linked to its Website and is
        not responsible for the contents of any such linked site. The presence
        of any link does not imply endorsement by Feelja of the site. The use of
      ...
      <p>
        Feelja may revise these Terms of Use for its Website at any time without
      ...
      <p>
        Any claim related to Feelja's Website shall be governed by the laws of
        de without regards to its conflict of law provisions.
      </p>
    </>
  );
}
